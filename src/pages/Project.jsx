  ...
  return (
    <div className="section ">
      ...
      <div className="pt-[42vh] pl-3 ">
        <h2 className="font-[font2] uppercase text-[15.6vw] relative">
          projets<sup className=" text-[3.2vw] absolute top-20 ">16</sup>
        </h2>
      </div>
      <div className="-mt-20 px-2.5 prnt  ">
        {projects.map((elem, idx) => {
          return (
            <div key={idx} className="hero w-full h-[50vh] mb-4 flex gap-2">
